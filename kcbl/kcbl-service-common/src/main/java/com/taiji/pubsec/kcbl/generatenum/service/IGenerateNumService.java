package com.taiji.pubsec.kcbl.generatenum.service;



import com.taiji.persistence.service.BaseService;
import com.taiji.pubsec.kcbl.generatenum.model.GenerateNum;
 ...
 *
 */
public interface IGenerateNumService extends BaseService<GenerateNum, String>{
	/**

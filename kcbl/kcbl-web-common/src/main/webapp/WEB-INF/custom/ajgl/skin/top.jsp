...
<div class="logo"><h1><a href="###" >贵阳市经开区分局全流程闭环式案件管理系统</a></h1>
</div>
<div class="c-top-right">
<ul>
<!--<li><a href="###"><span  class="link-index-icon"></span><i>首页</i></a></li>-->
  <li><a class="ajgl" href="###"><span class="link-icon aj-icon-1"></span><i>办案区管理</i></a></li>
  ...
  <li><a class="xxtx" href="###"><span class="link-message-icon"><span class="number">20</span></span><i>我的消息</i></a></li> 
  <li><div class="nav-ceng-out"><a href="###" class=""><span class="link-menu-icon"></span><i>系统导航</i></a>
         <div class="nav-ceng nav-systems" style="display: none;">
          <ul class="nav">
          <li><a class="ajgl" href="###"><span class="icon aj-icon-1"></span>办案区管理</a></li>

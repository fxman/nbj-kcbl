...
<script type="text/javascript" src="<%=request.getContextPath()%>/custom/kcbl/js/top.js"></script>
...
<div class="logo"><h1><a href="<%=request.getContextPath()%>/homePage/showHomePageJsp.action" >贵阳市经开区分局全流程闭环式案件管理系统</a></h1>
</div>

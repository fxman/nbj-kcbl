...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/custom/kcbl/js/left.js"></script>
<div class="user-box">
...
<div id="accordion" class="m-ui-accordion" style="display: none">
	...
	<div>
		<ul>
		    <li>
				<d:ss resource="/fileinfo/*"
							type="a" request="${pageContext.request}"
							otherAttribute='href="javascript:void(0);" myHref="${pageContext.request.contextPath}/fileinfo/tofileinfo.action"' value="文件管理" />	
			</li>
			<li>

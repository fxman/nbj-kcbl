...
<link rel="stylesheet" href="<%=request.getContextPath()%>/custom/kcbl/window-widget/anything-slider/css/anythingslider.css">

<link rel="stylesheet" href="<%=request.getContextPath()%>/custom/kcbl/style/utilBasic.css" />
<link rel="stylesheet" href="<%=request.getContextPath()%>/custom/kcbl/style/frame.css" />
<link rel="stylesheet" href="<%=request.getContextPath()%>/custom/kcbl/style/branch.css" />
<link rel="stylesheet" href="<%=request.getContextPath()%>/custom/kcbl/style/map.css" />
<script type="text/javascript" src="<%=request.getContextPath()%>/custom/kcbl/js/util.js"></script>
<style>
